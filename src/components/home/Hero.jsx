    ...
    <div className='h-[850px]  w-full pl-[50px] pr-[50px] bg-zinc-100'>
        <div className='w-full '>
            ...
            <div className='w-[1000px] ml-[150px]'>            
                ...
                <h3 className=' text-center text-xl mt-[20px] text-slate-700'> 
                Since the Foundation opened in 1869, it has offered some of the finest sports and social 
                facilities to its members. The Foundation has many spaces and areas for hire to non-members and guests. 
