...
function Card() {
  return (
    <div className='flex flex-col-4 space-x-[30px] pt-[20px] ml-[80px] mb-[100px]'>
        {cardData.map((data, index)=>{
            return(
                <div key={index} className='h-[300px] w-[250px] mt-[40px]'>
                    ...
                    <p className='mt-[100px] bg-blue-500 py-3 hover:bg-blue-300 hover:cursor-pointer'>{data.view}</p>
                    </a>
                </div>
            )
        })}
